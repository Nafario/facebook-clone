<template>
  <header class="h-15 bg-white flex items-center px-4 shadow">
    <div class="w-1/4">
      <div class="flex space-x-2" v-if="authUser.data">
        ...
        <div class="relative flex items-center">
          <div class="absolute text-gray-500">
            <svg viewBox="0 0 24 24" class="w-6 h-6 mt-2 ml-2 fill-current">
              <path
                fill-rule="evenodd"
    ...
    <div class="w-2/4 flex items-center justify-center h-full">
      ...
      <router-link
        to="/"
        class="px-6 border-b-2 border-transparent flex items-center h-full"
      >
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
